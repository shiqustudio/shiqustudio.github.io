...
⭐️  资源描述：一款浏览器标签页管理插件，可以让你用树状结构管理你的标签页，快速跳转到最近的标签页，分组标签页和窗口，以及保存和恢复标签页会话。

&gt;◉ 可以把你的标签页拖放到不同的分组或窗口，或者用右键菜单来移动或复制标签页。
&gt;◉ 可以给你的标签页分组或窗口添加标签，备注，颜色，图标等，方便你识别和搜索。
&gt;◉ 可以用快捷键或者工具栏按钮来快速打开或关闭插件的面板，或者切换到最近的标签页。
&gt;◉ 可以保存你当前的标签页会话，或者从历史记录中恢复之前的会话。你也可以导入或导出你的会话数据。

➡️  支持平台：#Firefox

🌐 资源地址：[点击跳转](https://addons.mozilla.org/en-US/firefox/addon/sessionpaw-onetab-outliner/)
...
> 作者:   
> URL: http://localhost:1313/tools/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E5%85%B7/  
